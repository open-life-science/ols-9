...
## (Ideally) Before this meeting:
   ...
   * Optional: Read this post on memorability: [https://ideas.ted.com/are-you-mentorable/](https://ideas.ted.com/are-you-mentorable/)🌍 Roll call
...
[Host] makes breakouts (15 min) [⏰ 45]
...
[Host] (10 min + 5 min for questions) [⏰ 65]
...
[HOST] makes breakouts (5 min) [⏰ 85]

5 min, 2 people/room

### Instructions for the room:

* Articulate your big idea, vision or dream that you want to achieve by working openly, and experimenting with expressing your vision in a short format.
* Add your project mission or vision below, and we’ll share it in breakout rooms
...
[Host] (10 min + 5 min for questions) [⏰ 80]
...
1. 📑** Open an issue on the OLS-9 repo** where you will be able to track your progress in this cohort: [https://github.com/open-life-science/ols-8](https://github.com/open-life-science/ols-9)
   1. **Create a GitHub account **if you don't have one
       ...
       1. **We can do a quick demo**: please stay on the call, or contact us on Slack or email and we will help you create an issue
